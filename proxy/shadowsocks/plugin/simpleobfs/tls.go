...
var (
	...
	ErrBadType         = newError("bad type")
	ErrBadMajorVersion = newError("bad major version")
	ErrBadMinorVersion = newError("bad minor version")
	ErrMaxDataLen      = newError("bad tls data len")
)
